  ...
  if(active){
    ...
    return(
      <div style={{ position:'fixed', top:0, left:0, right:0, bottom:0, background:BG, display:'flex', flexDirection:'column', overflow:'hidden', zIndex:60 }}>
        ...
        <div style={{ flex:1, overflowY:'auto', overflowX:'hidden', padding:'14px 14px 8px', display:'flex', flexDirection:'column', gap:10, minHeight:0 }}>
        ...
        <div style={{ background:CARD, borderTop:`1px solid ${LINE}`, padding:'10px 14px', display:'flex', gap:8, flexShrink:0, paddingBottom:'max(10px, env(safe-area-inset-bottom))' }}>
